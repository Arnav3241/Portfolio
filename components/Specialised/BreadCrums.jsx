                    ...
                    <Link href={`${link2}`}>
                        <li>
                            <div className="flex items-center">
                                <FcNext />
                                <a href="#" className="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">{title2}</a>
                            </div>
                        </li>
                    </Link>
                    {typeNo === 3 ?
                        <Link href={`${link3}`}>
                            <li aria-current="page">
                                <div className="flex items-center">
                                    <FcNext />
                                    <span className="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">{title3}</span>
                                </div>
                            </li>
                        </Link>
                    : null}
